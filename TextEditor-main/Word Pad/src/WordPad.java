...
public class WordPad implements ActionListener {
    ...
    WordPad() {
        ...
        more = new JMenu("More");
        light = new JMenuItem("Light Pad");
        light.addActionListener(this);
        dark = new JMenuItem("Dark Pad");
        dark.addActionListener(this);
        pink = new JMenuItem("Pink Pad");
        pink.addActionListener(this);
        green = new JMenuItem("Green Pad");
        green.addActionListener(this);
        orange = new JMenuItem("Orange Pad");
